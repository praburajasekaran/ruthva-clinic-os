...
consult_data = [
    dict(patient=pp[0], conducted_by=owner,
         ...
         naa="Coated tongue, white coating", niram="Slightly yellowish",
    ...
    dict(patient=pp[0], conducted_by=owner,
         ...
         nadi="Vatha Pitha - improving", naa="Tongue less coated",
    ...
    dict(patient=pp[1], conducted_by=owner,
         ...
         nadi="Pitha Vatha type", vizhi="Slight pallor in conjunctiva",
    ...
    dict(patient=pp[3], conducted_by=owner,
         ...
         nadi="Vatha Kapha type", mei="Cold to touch in joints",
